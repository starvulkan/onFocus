...
- One codebase set up to run as both a website and an extension

Still to come:

- The extension wrapper, and saved data that works in both versions
- Clock, greeting, NASA picture of the day, weather
